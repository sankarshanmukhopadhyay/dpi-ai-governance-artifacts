...
- `docs/overview.md` — how to use packs and controlled docs
- `packs/` — operational packs (starting point for implementers)
...
### Tier 3
- `docs/methodology-alignment.md` — TRACE alignment
- `annex/` — standards mappings and alignment notes
